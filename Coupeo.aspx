...
<ul itemscope itemtype="" class="breadcrumb">
    ...
    <li itemprop="itemListElement" itemscope itemtype="">
		<a itemprop="item" href="" class="pathway"><span itemprop="name">SEDAN</span></a>
		<span class="divider"><img src="templates/jm-car-dealer-ef4/images/system/arrow.png" alt="" /></span>
	</li>	
</ul></div></div></section>
...
<div id="djcatalog" class="djc_list djc_theme_jm-car-dealer-ef4">
    ...
    <div class="djc_subcategory djc_item pull_left djc_item_col_first" style="width:100%"><div class="djc_item_bg"><div class="djc_item_in djc_clearfix">
	    ...
	    <div class="djc_description"><div class="djc_item_info">
			...
			<div class="djc_price"><div class="djc_producer_info">
               ...
               <a class="djc_producer_items_link btn btn-mini button" href='<%# Eval("Brouchure") %>' target="_blank"><span>(Hot Offer)</span></a>
            </div></div>			                   	    		
	    </div></div>
    ...
    SelectCommand="SELECT * FROM [Carbtable] WHERE (([Categoryid] = @Categoryid) AND ([Status] = @Status) AND ([OfferStatus] = @oStatus)) ORDER BY [carid] DESC">
    <SelectParameters>
        <asp:Parameter DefaultValue="11" Name="Categoryid" Type="Int32" />
        <asp:Parameter DefaultValue="Yes" Name="Status" Type="String" />
        <asp:Parameter DefaultValue="Yes" Name="oStatus" Type="String" />
    </SelectParameters>
    </asp:SqlDataSource>
