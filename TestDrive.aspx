<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="TestDrive.aspx.vb" Inherits="TestDrive" %>
...
<div id="djcatalog" class="djc_clearfix djc_item djc_theme_jm-car-dealer-ef4">	
    ...
    <h3>Give Your Detail For Book a Test Drive</h3>
    <table class="table table-condensed">
        ...
        <tr>
            ...
            <td>Email<asp:RequiredFieldValidator ID="RequiredFieldValidator6" 
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                    ControlToValidate="TextBox7" Display="Dynamic" ErrorMessage="Invalid" 
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList3" runat="server" 
                    DataSourceID="SqlDataSource1" DataTextField="Name" DataValueField="DealerId"></asp:DropDownList>
            </td>
            <td>Upload Proof<asp:RequiredFieldValidator ID="RequiredFieldValidator8" 
        ...
        <tr>
            <td colspan="4" style="text-align:center">
                <div class="djc_readon"><asp:Button ID="Button1" runat="server" cssclass="btn button readmore" ValidationGroup="L" Text="Book A Test Drive" />
