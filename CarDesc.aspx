...
<div id="djcatalog" class="djc_clearfix djc_item djc_theme_jm-car-dealer-ef4">	
    <asp:DataList ID="DataList2" runat="server" DataKeyField="carid" DataSourceID="SqlDataSource5" RepeatColumns="1" Width="100%">
    <ItemTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Carbtable] WHERE ([carid] = @carid)">
	...
	<div class="djc_description">        
        ...
        <div class="djc_tabs">
            <ul class="nav nav-tabs">
                <li class="nav-toggler active" id="details"><a href="#details">Features</a></li>
                <li class="nav-toggler" id="video"><a href="#video">Technical Features</a></li>
                <li class="nav-toggler" id="test_drive"><a href="#test_drive">Gallery</a></li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane" id="tab-audi-a7-1"><div>
                ...
                <div class="tab-pane  active" id="tab-audi-a7-2"><div>
