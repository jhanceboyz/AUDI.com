<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="false" CodeFile="Car Gallery.aspx.vb" Inherits="Admin_Car_Gallery" %>
...
<div class="djc_title"><h3>List New Image for Car</h3></div>
<table class="table table-condensed">
    ...
    <tr>
        <td>
            Image<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
    ...
    <tr>
        <td>
            Title<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
    ...
    <tr>
        <td>
            &nbsp;</td>
        <td>
            <div class="djc_addtocart"><asp:Button ID="Button1" runat="server" cssclass="btn button readmore" Text="Add Car Gallery"  ValidationGroup="L" /></div>
        </td>
    </tr>
</table>
</asp:Content>
